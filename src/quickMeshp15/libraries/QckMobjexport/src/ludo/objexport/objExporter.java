 ...
 * 
 *  modified by ludo, added more vertex for quickmesh and translate uv.y coord (+1)
 * 
 */

package ludo.objexport;
...
public class objExporter extends PGraphics3D {
	...
	public void beginDraw() {
		...
		vertices = new float[4096][VERTEX_FIELD_COUNT];
	    ...
	    if (writer_obj == null) {
	      ...
	      lines = new int[4096][];
	      faces_groups_materials = new int[4096][];
	      lineCount = 0;
	      faceCount = 0;
